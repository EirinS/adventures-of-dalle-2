...
export class LivingroomScene extends BaseScene {
  ...
  constructor() {
    ...
    this.addText([
      "As Baobao arrived at Rosewood Mansion, he couldn't help but admire the grandeur of the exterior. The large, ornate gates and the imposing façade of the mansion were a testament (...)",
      "to the wealth of the crown. He took a moment to soak in the opulence of the estate before preparing to enter and begin his search for clues about whether or not Delara was a princess.",
    ]);
